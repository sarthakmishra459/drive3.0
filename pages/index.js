  ...
  return (
    <Layout >
      ...
      <div className="flex justify-center p-4">
        ...
        <form className="form flex items-center" onSubmit={handleFileUpload}>
          <label
            htmlFor="file-upload"
            className="choose bg-violet hover:bg-white  hover:text-black font-bold py-2 px-4 rounded-full cursor-pointer mr-4"
          >
            Add File
          </label>
          <input
          ...
          />
          <span className="textArea mr-4">File: {fileName}</span>
          <button
            type="submit"
            className="upload bg-violet hover:bg-white  hover:text-black cursor-pointer text-white font-bold py-2 px-4 rounded-full"
            disabled={!file}
          >
            Upload File
          </button>
